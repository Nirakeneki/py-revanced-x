    ...
    def run_build(self):
        ...
        process = subprocess.Popen(
            [
                ...
                "--bundle",
                self.download_files["Testpatch"],
                "--apk",
                input_apk_filepath,
                "--out",
                f"./{config['dist_dir']}/{target_app}-revanced-extended.apk",
                "--merge",
                self.download_files["Testinte"],
                "--keystore",
        ...
        output_path = f"./revanced-cache/{target_app}-revanced-extended_signed.apk"
